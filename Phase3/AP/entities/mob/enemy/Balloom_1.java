...
public class Balloom_1 extends Enemy {


    private boolean[] exp = {false, false, false, false};

    public Balloom_1(int x, int y, Board board, Game game) {
        super(x, y, board, game, game.getPlayerspeedConstant() / 2, 1 , "src/images/Balloom.jpg");
    }
