...
public class Kondoria_4 extends Enemy {
    private boolean onRandomMovement;
    private int randomMovementCount;
    private boolean[] exp = {false,false,false,false};
    public Kondoria_4(int x, int y, Board board, Game game) {
        super(x, y, board, game, game.getPlayerspeedConstant(), 4 , "src/images/Kondoria.jpg");
    ...
    public boolean collide(Entity e) {
        ...
        return !((e instanceof GrassTile) && ((GrassTile)e).HasBomb());
    }
